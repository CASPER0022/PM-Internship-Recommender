...
function LandingPage({ onResultsReady }) {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
        <div className={`w-full max-w-6xl mx-auto transform transition-all duration-1000 ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-gray-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Get personalized internship recommendations from the PM Internship Portal based on your skills and qualifications.
              </p>
            </div>
